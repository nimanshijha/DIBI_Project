...
for i in range(0,82):
    green_chromson_pos = []
    with open('C:/Users/niman/Desktop/dibi/35_0gy_2h_p6/EachCell_distance/green/Results'+ str(i) + '_green.csv') as csvfile:
    ...
    red_chromson_pos = []
    with open('C:/Users/niman/Desktop/dibi/35_0gy_2h_p6/EachCell_distance/red/Results'+ str(i) + '_red.csv') as csvfile:
...
distances_red_green1 = np.array(distances_red_green)
...
distances_red1 = np.array(distances_red)
plt.title("Image : 35_8gy_24h_p6 , Red Red Distances")
plt.hist(distances_red_green, bins=np.arange(distances_red_green.min(), distances_red_green.max()+1))
plt.show()

distances_green1 = np.array(distances_green)
